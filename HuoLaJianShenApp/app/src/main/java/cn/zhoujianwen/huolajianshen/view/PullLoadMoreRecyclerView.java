...
public class PullLoadMoreRecyclerView extends LinearLayout {
    ...
    private void initView(Context context) {
        mContext = context;
        View view = LayoutInflater.from(context).inflate(cn.zhoujianwen.huolajianshen.R.layout.pull_load_more_layout, null);
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(cn.zhoujianwen.huolajianshen.R.id.swipeRefreshLayout);
        mSwipeRefreshLayout.setColorSchemeResources(android.R.color.holo_green_dark, android.R.color.holo_blue_dark, android.R.color.holo_orange_dark);
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayoutOnRefresh(this));

        mRecyclerView = (RecyclerView) view.findViewById(cn.zhoujianwen.huolajianshen.R.id.recycler_view);
        ...
        mFooterView = (LinearLayout) view.findViewById(cn.zhoujianwen.huolajianshen.R.id.footer_linearlayout);
