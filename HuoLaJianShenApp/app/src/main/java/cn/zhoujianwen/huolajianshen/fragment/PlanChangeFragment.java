...
public class PlanChangeFragment extends BaseFragment {
    ...
    @Bind(cn.zhoujianwen.huolajianshen.R.id.lcv_plan_change)
    LineChartView lcvPlanChange;

    ArrayList<GoalRecordInfo> goalRecordInfos;
    @Bind(cn.zhoujianwen.huolajianshen.R.id.fab_plan_change)
    ...
    protected int getLayoutResource() {
        return cn.zhoujianwen.huolajianshen.R.layout.fragment_plan_change;
    }
