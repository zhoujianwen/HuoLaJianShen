package cn.zhoujianwen.huolajianshen.db;
...
public class DBHelper extends SQLiteOpenHelper {
	...
	private static String DB_PATH = "/data/data/cn.zhoujianwen.huolajianshen/databases/";
	/*
	 * //如果你想把数据库文件存放在SD卡的话 private static String DB_PATH =
	 * android.os.Environment.getExternalStorageDirectory().getAbsolutePath() +
	 * "/arthurcn/drivertest/packfiles/";
	 */
	private static String DB_NAME = "huolajianshen-food-sport.db";
	private static String ASSETS_NAME = "huolajianshen-food-sport.db";
